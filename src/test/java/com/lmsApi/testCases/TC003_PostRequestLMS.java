...
public class TC003_PostRequestLMS extends TestBase {
	@Test(dataProvider="POSTrequest",dataProviderClass=DataProvider_LMS.class,priority=1) 
	void post_record(String ProgramID,String ProgramName,String ProgramDesc,String Online,String StatusCode) {
	    ...
	    //send post request
				...
				if(sc==200) {
					...
					//get program id autogenerated
					
					int id = jsonpath.get("programId");
					...
					System.out.println("The program id is: "+id);
				...
				System.out.println("<-----------------POST Validations-------------->");
